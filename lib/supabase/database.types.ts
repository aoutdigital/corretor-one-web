...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      admin_users: {
        Row: {
          ...
          status: Database["public"]["Enums"]["status_admin"];
      ...
      imoveis: {
        Row: {
          ...
          owner_id: string;
          ocupacao_imovel:
            | Database["public"]["Enums"]["ocupacao_imovel"]
            | null;
      ...
      landing_page_events: {
        Row: {
          created_at: string;
          event_type: Database["public"]["Enums"]["landing_page_event_type"];
          id: string;
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "landing_page_events_owner_id_fkey";
            columns: ["owner_id"];
            isOneToOne: false;
            referencedRelation: "profiles";
            referencedColumns: ["id"];
      ...
      public_events: {
        Row: {
          ...
          resource_type: Database["public"]["Enums"]["public_resource_type"];
          resource_id: string | null;
          event_type: Database["public"]["Enums"]["public_event_type"];
          page_url: string | null;
          metadata: Json;
          occurred_at: string;
        };
      ...
      templates: {
        Row: {
          ...
          objetivo: Database["public"]["Enums"]["objetivo_template"];
          provider: Database["public"]["Enums"]["provider_template"];
          renderer_key: string;
          version: number;
          mode: Database["public"]["Enums"]["creative_template_mode"];
          formatos: Database["public"]["Enums"]["creative_output_format"][];
      ...
      posts: {
        Row: {
          id: string;
          owner_id: string;
          subject_type: Database["public"]["Enums"]["public_resource_type"];
          subject_id: string;
          template_id: string;
          tipo: Database["public"]["Enums"]["tipo_post"];
          formato: Database["public"]["Enums"]["creative_output_format"];
          status: Database["public"]["Enums"]["status_post"];
      ...
      lead_attributions: {
        Row: {
          ...
          last_non_direct_touch_id: string | null;
          assisted_touch_ids: string[];
      ...
      landing_pages: {
        Row: {
          ...
          tema_config: Json;
          tipo: Database["public"]["Enums"]["landing_page_tipo"];
          titulo: string;
          updated_at: string;
        };
        Insert: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "landing_pages_imovel_id_fkey";
            columns: ["imovel_id"];
            isOneToOne: false;
            referencedRelation: "imoveis";
            referencedColumns: ["id"];
      ...
      lead_empreendimentos: {
        ...
        Relationships: [
          {
            foreignKeyName: "lead_empreendimentos_empreendimento_id_fkey";
            columns: ["empreendimento_id"];
            isOneToOne: false;
            referencedRelation: "empreendimentos";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "lead_empreendimentos_lead_id_fkey";
            columns: ["lead_id"];
            isOneToOne: false;
            referencedRelation: "leads";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "lead_empreendimentos_owner_id_fkey";
            columns: ["owner_id"];
            isOneToOne: false;
            referencedRelation: "profiles";
            referencedColumns: ["id"];
      ...
      negocios: {
        Row: {
          ...
          subfase_juridica:
            | Database["public"]["Enums"]["subfase_juridica_negocio"]
            | null;
          titulo: string | null;
          updated_at: string;
          valor: number | null;
      ...
      profile_public_paths: {
        Row: {
          ...
          owner_id: string;
          resource_id: string;
          resource_type: Database["public"]["Enums"]["public_path_resource"];
          slug: string;
          updated_at: string;
        };
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: "profile_public_paths_owner_id_fkey";
            columns: ["owner_id"];
            isOneToOne: false;
            referencedRelation: "profiles";
            referencedColumns: ["id"];
    ...
    Enums: {
      ...
      objetivo_template:
        | "PROMOVER_IMOVEL"
        | "PROMOVER_EMPREENDIMENTO"
        | "PROMOVER_ARTIGO"
        | "PROMOVER_LANDING_PAGE"
        | "PROMOVER_PERFIL";
