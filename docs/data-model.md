...
- Para publicar, o artigo exige título real, subtítulo, imagem de capa e pelo menos 1 bloco de conteúdo. Título vazio ou técnico de rascunho (`Sem título`, `Novo artigo do corretor`) não pode ser publicado.
